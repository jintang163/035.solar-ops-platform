...
CREATE TABLE station (
    ...
    total_investment DECIMAL(14,2) DEFAULT NULL COMMENT '总投资额（元）',
    annual_operation_cost DECIMAL(12,2) DEFAULT NULL COMMENT '年运维成本（元）',
    design_life INT DEFAULT 25 COMMENT '设计寿命（年）',
...
-- 初始化电站数据
INSERT INTO station (station_name, station_code, capacity, address, longitude, latitude, contact, contact_phone, peak_sun_hours, total_investment, annual_operation_cost, design_life, status, create_time, update_time) VALUES
('阳光一号光伏电站', 'ST-2024-001', 5000.00, '北京市海淀区中关村大街1号', 116.310000, 39.980000, '张工', '13900139001', 4.20, 25000000.00, 250000.00, 25, 1, NOW(), NOW()),
('绿色能源二号电站', 'ST-2024-002', 3000.00, '上海市浦东新区张江高科技园区', 121.550000, 31.200000, '李工', '13900139002', 3.80, 18000000.00, 150000.00, 25, 1, NOW(), NOW()),
('西部太阳能发电站', 'ST-2024-003', 8000.00, '甘肃省酒泉市肃州区', 98.520000, 39.730000, '赵工', '13900139003', 5.50, 40000000.00, 400000.00, 25, 1, NOW(), NOW());
...
CREATE TABLE electricity_price_scheme (
    ...
    station_id BIGINT DEFAULT NULL COMMENT '��վID��NULL��Ϊȫ��Ĭ�Ϸ�����',
    grid_price DECIMAL(10,4) NOT NULL DEFAULT 0.0000 COMMENT '������ۣ�Ԫ/kWh��',
    benchmark_price DECIMAL(10,4) DEFAULT 0.0000 COMMENT '����ú��׼��ۣ�Ԫ/kWh��',
    national_subsidy DECIMAL(10,4) DEFAULT 0.0000 COMMENT '���Ҳ�����ۣ�Ԫ/kWh��',
    provincial_subsidy DECIMAL(10,4) DEFAULT 0.0000 COMMENT 'ʡ��������ۣ�Ԫ/kWh��',
    municipal_subsidy DECIMAL(10,4) DEFAULT 0.0000 COMMENT '�м�������ۣ�Ԫ/kWh��',
    subsidy_start_date DATE DEFAULT NULL COMMENT '������ʼ����',
    subsidy_end_date DATE DEFAULT NULL COMMENT '�����������ڣ�NULL������Ч��',
    is_parity TINYINT DEFAULT 0 COMMENT '�Ƿ�ƽ��������0�� 1��',
    is_default TINYINT DEFAULT 0 COMMENT '�Ƿ�ΪĬ�Ϸ�����0�� 1��',
    status TINYINT DEFAULT 1 COMMENT '״̬��0ͣ�� 1����',
    ...
    deleted TINYINT NOT NULL DEFAULT 0 COMMENT 'ɾ����� 0-δɾ�� 1-��ɾ��',
    PRIMARY KEY (id),
    KEY idx_station_id (station_id),
    KEY idx_is_default (is_default),
    KEY idx_status (status),
    KEY idx_create_time (create_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='��۷�����';
...
CREATE TABLE revenue_statistics (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT '����ID',
    station_id BIGINT NOT NULL COMMENT '��վID',
    price_scheme_id BIGINT NOT NULL COMMENT '��۷���ID',
    statistics_date DATE NOT NULL COMMENT 'ͳ������',
    statistics_type TINYINT NOT NULL DEFAULT 1 COMMENT 'ͳ�����ͣ�1�� 2�� 3�� 4��',
    grid_energy DECIMAL(12,2) DEFAULT 0.00 COMMENT '����������kWh��',
    grid_revenue DECIMAL(12,2) DEFAULT 0.00 COMMENT '������ѣ�Ԫ��',
    national_subsidy_revenue DECIMAL(12,2) DEFAULT 0.00 COMMENT '���Ҳ�����Ԫ��',
    provincial_subsidy_revenue DECIMAL(12,2) DEFAULT 0.00 COMMENT 'ʡ��������Ԫ��',
    municipal_subsidy_revenue DECIMAL(12,2) DEFAULT 0.00 COMMENT '�м�������Ԫ��',
    total_subsidy_revenue DECIMAL(12,2) DEFAULT 0.00 COMMENT '�����ܽ�Ԫ��',
    total_revenue DECIMAL(12,2) DEFAULT 0.00 COMMENT '�����棨Ԫ��',
    unit_energy_cost DECIMAL(10,4) DEFAULT 0.0000 COMMENT '�ȵ�ɱ���Ԫ/kWh��',
    operation_cost DECIMAL(12,2) DEFAULT 0.00 COMMENT '��ά�ɱ���Ԫ��',
    effective_grid_price DECIMAL(10,4) DEFAULT 0.0000 COMMENT 'ʵ��������ۣ�Ԫ/kWh��',
    settlement_status TINYINT DEFAULT 0 COMMENT '����״̬��0δ���� 1�ѽ���',
    create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '����ʱ��',
    update_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '����ʱ��',
    deleted TINYINT NOT NULL DEFAULT 0 COMMENT 'ɾ����� 0-δɾ�� 1-��ɾ��',
    PRIMARY KEY (id),
    ...
    KEY idx_create_time (create_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='�������ͳ�Ʊ�';
...
('ȫ��Ĭ��������۷���', NULL, 0.3964, 0.3964, 0.0000, 0.0000, 0.0000, NULL, NULL, 1, 1, 1, 'ȫ��Ĭ��ƽ��������۷���'),
('�������������ۣ���������', 1, 0.3964, 0.3964, 0.0500, 0.0300, 0.0200, '2023-01-01', '2025-12-31', 0, 0, 1, '�����������������ۣ������Ҳ���0.05Ԫ��ʡ������0.03Ԫ���м�����0.02Ԫ'),
('�Ϻ����������ۣ���������', 2, 0.4155, 0.4155, 0.0500, 0.0250, 0.0150, '2023-01-01', '2025-12-31', 0, 0, 1, '�Ϻ��������������ۣ������Ҳ���0.05Ԫ��ʡ������0.025Ԫ���м�����0.015Ԫ');
