...
@Data
@ApiModel(value = "清洗计划VO")
public class CleaningPlanVO {
    ...
    @ApiModelProperty(value = "清洗前照片URL列表")
    private List<String> beforeCleanPhotoList;

    @ApiModelProperty(value = "清洗后照片URL列表")
    private List<String> afterCleanPhotoList;
    ...
    @ApiModelProperty(value = "提升率百分比（用于展示）")
    private BigDecimal improvementRatePercent;
